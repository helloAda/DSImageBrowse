...
@interface ViewController ()<UITableViewDelegate,UITableViewDataSource,DSImageBrowseCellDelegate,UIViewControllerPreviewingDelegate>
...
- (void)didClick:(DSImageBrowseView *)imageView atIndex:(NSInteger)index {
    ...
    DSImageShowView *scrollView = [[DSImageShowView alloc] initWithItems:items];
